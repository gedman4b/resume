...
<head>
    ...
    <title>Interactive Resume | Scott Josephson - Head/Director of AI</title>
    ...
    <!-- Application Structure Plan: A single-page application with a fixed sidebar navigation for seamless exploration. The structure includes: 1) An 'Overview' section with a professional summary and an interactive radar chart of core competencies for a strong first impression. 2) An 'Experience' section featuring a vertical timeline to intuitively guide the user through a 30-year career, with clickable entries revealing detailed accomplishments. 3) A dedicated 'Innovations & Publications' section to highlight thought leadership (patent, projects, papers). 4) A final 'Education & Credentials' section. This non-linear, interactive structure allows stakeholders (CEOs, tech managers, recruiters) to access the information most relevant to them directly, making a dense career history digestible and engaging. -->
    <!-- Visualization & Content Choices: 1. Core Competencies Radar Chart: Info: Broad skill categories (Strategy, GenAI, Knowledge Rep, etc.). Goal: Provide a quick, holistic view of his multi-faceted expertise. Viz: Chart.js Radar Chart. Interaction: Hover to see skill categories. Justification: Visually more impactful than a list, immediately conveying balanced, high-level expertise required for a Director. 2. Career Timeline: Info: Chronological job history. Goal: Present a long career path in a compact, explorable format. Viz: Vertical timeline with styled divs. Interaction: Click on a job title to expand a panel with detailed, quantified achievements. Additionally, a new "Summarize Experience" button leverages the Gemini API to provide an AI-generated concise summary of the selected experience's key accomplishments. Justification: Turns a potentially overwhelming list into an interactive journey of progression, with an added AI-powered shortcut for quick understanding. 3. Key Impact Metrics: Info: Quantifiable achievements (e.g., '20-30% efficiency gain'). Goal: Make business value stand out. Viz: Styled list items with icons within the timeline details. Interaction: Static but visually prominent. Justification: Directly answers the 'so what?' by highlighting tangible business impact. -->
        ...
        <aside class="w-full lg:w-64 bg-white lg:h-screen lg:fixed lg:border-r border-slate-200 p-6">
            ...
            <nav class="mt-8">
                <ul class="space-y-2">
                    ...
                    <li><a href="#innovations" class="nav-link flex items-center px-4 py-2.5 rounded-lg">
        ...
        const resumeData = {
            experience: [
                ...
                },
                {
                    ...
                    points: [
                        "Led the evaluation and strategic recommendation of leading LLMs (GPT, Claude, Llama, Mistral) to inform critical technology adoption decisions for enterprise AI solutions.",
                ...
                },
                {
                    ...
                    points: [
                        "Developed and executed quarterly data science roadmaps, delivering critical predictive models for public health initiatives (CDC).",
